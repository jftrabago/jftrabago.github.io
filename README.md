	...
	<table style="width:100%">
	  <tr>	
		...
		<p><code style="color : fuchsia"><i class="fa fa-envelope" style="font-size:16px;color:fuchsia">&nbsp;jftrabago[at]gmail.com</i></code></p>
  		...
  		<p><code style="color : blue"><i class="fa fa-file" style="font-size:20px;color:blue"></i>&nbsp;<a target="_blank" rel="noopener noreferrer" style="font-size:16px;color:blue" href="https://drive.google.com/file/d/1jbHbvVze-FjQspOJSDULz2vC7aZvJg_p/view?usp=share_link">Curriculum Vitae</a></code></p>
	    </td>	
